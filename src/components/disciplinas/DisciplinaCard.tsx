      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              <Badge className="bg-blue-100 text-blue-700">
                ...
                {t('components.disciplinas.card.order', { order: disciplina.ordem })}
              </Badge>
            </div>
          ...
          <div className="flex items-center gap-2 bg-green-50 px-3 py-2 rounded-lg">
            ...
            <span className="font-semibold text-green-600">{t('components.disciplinas.card.workloadValue', { hours: disciplina.carga_horaria })}</span>
          </div>
        </div>
        ...
        {disciplina.ementa && (
          <div className="pt-4 border-t">
            <p className="text-xs text-gray-500 mb-1">{t('components.disciplinas.card.ementaLabel')}</p>
        ...
        <div className="flex items-center gap-2 pt-4 border-t">
          {onView && (
            ...
            >
              ...
              {t('components.disciplinas.card.view')}
            </Button>
          )}
